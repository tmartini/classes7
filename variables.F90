...
real(8), parameter :: Ga_W    = 2.0465488583055417d0   *GeV      ! W boson width(PDG-2011)
real(8), parameter :: m_top   = 173.2d0  *GeV           ! top quark mass
real(8), parameter :: Ga_Top  = 1.5016491886818755d0  *GeV           ! top quark width
...
real(8), parameter :: alphas = 0.13429422946317321d0         ! strong coupling
